...
public class GameplayScene implements Scene{
    ...
    public GameplayScene() {
        player = new RectPlayer(new Rect(100,100,200,200),
                Color.rgb(255,0,0));
        playerPoint = new Point(Constants.SCREEN_WIDTH/2, Constants.SCREEN_HEIGHT*5/6);
        player.update(playerPoint);
        obstacleManager = new ObstacleManager(300, 400, 75, Color.BLUE);
    ...
    public void update() {
        if (!gameOver) {
            ...
            if (playerPoint.y > Constants.SCREEN_HEIGHT) playerPoint.y = 0;
            player.update(playerPoint);
